...
/** Options for queuing duplicate requests until the active request completes. */
...
/**
 * Queues duplicate requests and releases them sequentially after the active request completes.
 */
