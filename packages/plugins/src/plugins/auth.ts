...
import type { IPlugin, ISharedCache } from "../intf";
...
/** Options for asynchronous authentication checks before request dispatch. */
...
/**
 * Verifies or establishes authentication before Axios sends a matching request.
 *
 * `login` may refresh a token, show a login flow, or restore a session.
 */
