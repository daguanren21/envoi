...
/** Options for sharing one in-flight response across equivalent requests. */
...
/**
 * Coalesces equivalent in-flight requests and distributes one response or final error to all callers.
 */
  ...
  return {
    ...
    lifecycle: {
      ...
      exceptionObserved: {
        runWhen,
        /**
         * 最终请求失败后, 向缓存中的请求分发异常并保持 rejected 状态
         */
